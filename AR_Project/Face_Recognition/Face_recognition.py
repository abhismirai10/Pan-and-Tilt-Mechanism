...
known_faces = {
    "Abhi": load_and_encode_face('AR_Project/Face_Recognition/known_faces/person_1/person_1_face-5.jpg'),
...
while True:
    ...
    for face_location, face_encoding in zip(face_locations, face_encodings):
        ...
        # Display the face name and custom message on the frame
        if face_name == "Abhi":
            cv2.putText(frame, "Hey Abhi, what's up!", (50, 50), font, 1, (255, 0, 0), 2)
        elif face_name == "Derek":
            cv2.putText(frame, "Derek COO Jaycon Systems", (50, 50), font, 1, (0, 255, 0), 2)
        elif face_name == "Jay":
            cv2.putText(frame, "Jay CEO Jaycon Systems", (50, 50), font, 1, (0, 0, 255), 2)
        else:
            cv2.putText(frame, face_name, (50, 50), font, 1, (0, 0, 255), 2)
